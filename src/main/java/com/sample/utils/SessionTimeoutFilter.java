...
public class SessionTimeoutFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        System.out.println("SessionTimeoutFilter: Intercepting request for URL: " + httpRequest.getRequestURI());
        ...
        if (session != null) {
            ...
            if (loginTime != null && hasSessionTimedOut(loginTime)) {
                ...
                System.out.println("SessionTimeoutFilter: Session has timed out. Redirecting to login page.");
